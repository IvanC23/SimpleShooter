...
struct Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_SimpleShooter_SimpleShooter_Source_SimpleShooter_ShooterCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterCharacter, AShooterCharacter::StaticClass, TEXT("AShooterCharacter"), &Z_Registration_Info_UClass_AShooterCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterCharacter), 3897764189U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_crusc_Documents_GitHub_SimpleShooter_SimpleShooter_Source_SimpleShooter_ShooterCharacter_h_1789264114(TEXT("/Script/SimpleShooter"),
